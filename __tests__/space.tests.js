...
describe('Person', () => {
  ...
  test('should display user years lived past on Mars', () => {
    ...
    expect(marsPast.showDisplayMars()).toEqual(` Your age on Mars is : ${age} You have lived ${exp} years past the life expectancy on Mars`);
  }); 
  ...
  test('should display user years lived past on Jupiter', () => {
    let jupLeft = new Person ("GlenBuck", 79)
